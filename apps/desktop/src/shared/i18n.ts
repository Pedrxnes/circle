...
const ptBR: Strings = {
  ...
  showPercentHint: "Desligue para deixar apenas o anel.",
  ...
  colorFixed: "Cor fixa",
  colorFixedHint: "Desenha o anel sempre na cor escolhida.",
  customColor: "Personalizada",
  ringMetric: "Métrica do anel",
  ringMetricHint: "Qual janela o anel externo e a porcentagem seguem.",
